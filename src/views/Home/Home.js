...
const web3 = new Web3('https://api.avax.network/ext/bc/C/rpc'); // Replace with the desired Polygon RPC endpoint

// Define the smart contract address and ABI
const contractAddress = '0x29be75c6813753dA09a737ec1F2adaaD0F19Db3F';
    ...
    <Switch>
      <Page>
        <Route exact path={path}>
          ...
          <h2 style={{ textAlign:'center', marginBottom: '5px', fontColor: '#d65752' , backgroundColor: '#f7e18b'  }}>COQ INU PIXELS</h2>
          <Grid container justify="center" spacing={0} style={{marginTop: '10px', marginBottom: '10px'}}>
                      
            <span>
             <span style={{fontSize: '20px', color: '#000'}}>Total Minted
             </span>
               <br></br><span style={{color: '#000'}} id="resultsupply"></span><span style={{color: '#000'}} id="resultsupply"> /1000
          ...
          <Grid container justify="center" spacing={0} style={{marginTop: '10px', marginBottom: '10px'}}>
                      ...
                      <h4 style={{ textAlign:'center', marginBottom: '2px', color: '#000'  }}>1 AVAX</h4>
                  </Grid>
                 </Grid>
              <span>
                      <circleButton
                      ...
                      >
                       ...
                       <span style={{color: '#d65752', fontSize: '2rem'}} > &nbsp;{mintAmount}&nbsp;</span>
                      ...
                      <mintButton style={{marginTop: '10px', marginBottom: '10px', border: '3px solid #000', backgroundColor: '#d65752', TransformStream: 'transform .1s ease-in-out' }}
            ...
            <span style={{ fontSize: '36px', color: '#000' }}>
              { parseInt(nftStakedTotalSupply * 100 / nftTotalSupply) } % COQ INU PIXELS STAKED
            </span>
